...
class ActivateOnNewCustomers extends StatelessWidget {
  ...
  Widget build(BuildContext context){
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: CustomAppBar(title: 'Activate On New Customers'),
        drawer: StoreDrawer(),
        body: Content(),
      )
    );
              ...
              child: Form(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Row(
                      children: [
                        Text('Activate On New Customers'),
                        Switch(
                          activeColor: Colors.green,
                          value: couponForm['allow_discount_on_new_customer'], 
                          onChanged: (status){
                            setState(() {
                              couponForm['allow_discount_on_new_customer'] = status;
                            });
                          }
                        )
                      ],
                    ...
                    CustomCheckmarkText(
                      text: couponForm['allow_discount_on_new_customer']
                        ? 'This coupon is valid for only new customers' 
                        : 'This coupon is not limited to new customers'
                    ),
